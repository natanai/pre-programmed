...
const migrations: Migration[] = [
  ...
  {
    id: 9,
    name: "extensible-operation-ids",
    sql: `
      CREATE TABLE operation_hooks_v9 (
        id TEXT PRIMARY KEY,
        target_kind TEXT NOT NULL CHECK (target_kind IN ('item', 'variable', 'computed')),
        target_id TEXT NOT NULL,
      ...
      INSERT INTO operation_hooks_v9
        (id, target_kind, target_id, operation, order_index, condition_json, response_text, effects_json, success)
      ...
      ALTER TABLE operation_hooks_v9 RENAME TO operation_hooks;
  ...
  {
    id: 12,
    name: "interaction-response-speakers",
    sql: `
      ALTER TABLE interaction_outcomes
      ADD COLUMN response_speaker_id TEXT;

      UPDATE project_meta SET schema_version = 12 WHERE id = 1;
    `,
  },
];
